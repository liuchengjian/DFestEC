...
import lchj.latte.ec.ScaleUpAnimator;
import lchj.latte.net.RestClient;
import lchj.latte.net.callback.ISuccess;
import lchj.latte.ui.animation.BezierAnimation;
import lchj.latte.ui.animation.BezierUtil;
import lchj.latte.ui.banner.HolderCreator;
import lchj.latte.ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends LatteDelegate implements
    ...
    public void onAnimationEnd() {
        ...
        RestClient.builder()
                .url(AllUrl.ADD_SHOP_CART_COUNT)
                .success(new ISuccess() {
                    @Override
                    public void onSuccess(String response) {
