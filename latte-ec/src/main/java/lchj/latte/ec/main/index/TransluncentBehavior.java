...
import lchj.latte.ui.recycler.RgbValue;

/**
 * Created by XiMiTwo on 2017/10/18.
 */
...
public class TransluncentBehavior extends CoordinatorLayout.Behavior<Toolbar> {
  //顶部距离
    ...
    //定义变化颜色
    private final RgbValue RGB_VALUE = RgbValue.create(255,255,15);
